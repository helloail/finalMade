...
public class SearchTvShowViewModel extends ViewModel {
    ...
    private MutableLiveData<ArrayList<SearchTvShowInit>> listsearchtvshow = new MutableLiveData<>();


    public void setSearch (final String url, final String text ) {

        final ArrayList<SearchTvShowInit> listItems = new ArrayList<>();
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArrayData.length(); i++) {
                                ...
                                SearchTvShowInit data = new Gson().fromJson(jsonObjectData.toString(), new TypeToken<SearchTvShowInit>() {
                                }.getType());
...
//                            ApiError apiError = error.getErrorAsObject(ApiError.class);
    ...
    public LiveData<ArrayList<SearchTvShowInit>> getSearch() {
